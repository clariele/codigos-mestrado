# cnn_poda_random_unstructured.py
# ============================================================
# CNN 1D (PyTorch) — PODA NÃO ESTRUTURADA RANDOM
...
INA_ADDR        = 0x40
OUT_CSV         = "resultados_cnn_poda_random_unstructured.csv"

SPARSITY_LEVELS = [0.2, 0.4, 0.6, 0.8]  # taxas de poda
...
def main():
    ...
    for fold_id,(train_idx,val_idx) in enumerate(splits,1):
        ...
        for sparsity in SPARSITY_LEVELS:
            ...
            # aplicar poda random unstructured
            prune.random_unstructured(model.conv1, name="weight", amount=sparsity)
            prune.random_unstructured(model.conv2, name="weight", amount=sparsity)
            prune.random_unstructured(model.fc1,   name="weight", amount=sparsity)
