# cnn_poda_l1_unstructured.py
# ============================================================
# CNN 1D (PyTorch) — PODA NÃO ESTRUTURADA BASEADA EM L1
...
INA_ADDR        = 0x40
OUT_CSV         = "resultados_cnn_poda_l1_unstructured.csv"
...
def main():
    ...
    for fold_id,(train_idx,val_idx) in enumerate(splits,1):
        ...
        for sparsity in SPARSITY_LEVELS:
            ...
            # aplicar poda não estruturada L1
            prune.l1_unstructured(model.conv1, name="weight", amount=sparsity)
            prune.l1_unstructured(model.conv2, name="weight", amount=sparsity)
            prune.l1_unstructured(model.fc1,   name="weight", amount=sparsity)
